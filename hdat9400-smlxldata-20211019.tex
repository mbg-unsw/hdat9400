...
\begin{frame}{Why does data size matter?}
	...
	\item Two times bigger can be more than two times slower 
    \end{itemize}
\end{frame}
...
\begin{frame}{How can we process the data?}
    \begin{tabular}{lrrl}
...
% -	The simplest thing: a table scan
% o	Sometimes you just need to shlepp through the data
%
...
% o	Digression on parallel processing? MapReduce
%
% -	Demo, adding an index in SAS and the WHERE
%
...
% -	Potential diversion: Parallel processing, MapReduce
